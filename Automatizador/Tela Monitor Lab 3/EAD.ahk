...
F3::
{
    ...
    ; Clica nas coordenadas (505, 874)
    Click, 505, 874
    Sleep, 800  ; Espera meio segundo

    ; Clica nas coordenadas (229, 10)
    Click, 229, 10
    Sleep, 500  ; Espera meio segundo

    ; Clica nas coordenadas (248, 64)
    Click, 248, 64
    Sleep, 500  ; Espera meio segundo
    ...
    Click, 607, 386, 2 ; 2 significa duplo clique
...
F10::
{
    ...
    ; Clica em 439, 12
    Click, 534, 15
    Sleep, 1200  ; Espera 0.3 segundos
...
+F10::  ; Shift + F10
{
    ...
    ; Clica em 439, 12
    Click, 534, 15
    Sleep, 1200  ; Espera 0.6 segundos
